...
from src.capture_pkg.screenshot import image_to_base64
from src.config import get_openai_key, get_openai_model
from src.integrations.openai_client import completion_kwargs
from src.recording.meeting_recorder import format_time
